...
Be careful with the L led on the Arduino. If it switch on (orange), then the
Arduino will not compute any data from the tablet. You need to reset the
Arduino with the Arduino button. This is in fact the emergency signal, more
informations on section~\ref{subsec:emergency}.
...
download, open the project in it.
